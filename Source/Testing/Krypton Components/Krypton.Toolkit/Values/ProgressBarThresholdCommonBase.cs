...
public class ProgressBarThresholdCommonBase
{
    ...
    /// <summary>
    /// Initialize a new instance of the ProgressBarThresholdCommonBase class.
    /// </summary>
    public ProgressBarThresholdCommonBase()
    {
        Reset();
    }
    ...
    [Category(@"Visuals")]
    [Description(@"Background color. Empty uses default.")]
    ...
    [Category(@"Visuals")]
    [Description(@"Text color. Empty uses default.")]
    [DefaultValue(typeof(Color), nameof(Color.Empty))]
    [KryptonDefaultColor]
