...
public class ProgressBarThresholdRegionBack
{
    #region Instance Fields

    private readonly ProgressBarThresholdRegionState _parent;
    ...
    /// <summary>
    /// Initialize a new instance of the ProgressBarThresholdRegionBack class.
    /// </summary>
    /// <param name="parent">Reference to owning state.</param>
    /// <param name="defaultColor1">Default color1 value.</param>
    public ProgressBarThresholdRegionBack(ProgressBarThresholdRegionState parent, Color defaultColor1)
    {
        _parent = parent;
    ...
    /// </summary>
    [Browsable(false)]
    public bool IsDefault => _color2 == Color.Empty &&
                             _colorStyle == PaletteColorStyle.Inherit &&
                             _colorAlign == PaletteRectangleAlign.Inherit &&
