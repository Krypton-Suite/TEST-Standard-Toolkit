...
public class ProgressBarThresholdRegionContent
{
    ...
    /// <summary>
    /// Initialize a new instance of the ProgressBarThresholdRegionContent class.
    /// </summary>
    /// <param name="parent">Reference to owning state.</param>
    public ProgressBarThresholdRegionContent(ProgressBarThresholdRegionState parent)
    {
        _parent = parent;
        _color1 = Color.Empty;
        _color2 = Color.Empty;
    ...
    /// </summary>
    [Browsable(false)]
    public bool IsDefault => _color1 == Color.Empty &&
                             _color2 == Color.Empty &&
                             _colorStyle == PaletteColorStyle.Inherit &&
                             _colorAlign == PaletteRectangleAlign.Inherit &&
