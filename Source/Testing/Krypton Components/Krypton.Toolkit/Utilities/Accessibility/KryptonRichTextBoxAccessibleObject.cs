...
/// <summary>
/// Provides accessibility information for KryptonRichTextBox control.
/// Delegates to the internal RichTextBox's accessibility object to ensure proper UIA provider support.
/// </summary>
internal class KryptonRichTextBoxAccessibleObject : Control.ControlAccessibleObject
{
    #region Instance Fields
    private readonly KryptonRichTextBox _owner;
    #endregion

    #region Identity
    /// <summary>
    /// Initialize a new instance of the KryptonRichTextBoxAccessibleObject class.
    /// </summary>
    /// <param name="owner">The KryptonRichTextBox control that owns this accessible object.</param>
    public KryptonRichTextBoxAccessibleObject(KryptonRichTextBox owner)
        : base(owner)
    {
        _owner = owner;
    }
    ...
    public override AccessibleRole Role
    {
        get
        {
            // Delegate to internal RichTextBox's role
            var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
            ...
            // Fall back to Text role for RichTextBox controls
    ...
    public override AccessibleStates State
    {
        get
        {
            // Delegate to internal RichTextBox's state
            var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
            if (internalAccessible != null)
            {
    ...
    public override string? Value
    {
        get
        {
            // Delegate to internal RichTextBox's value (which contains the text)
            var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
    ...
    {
        // Delegate to internal RichTextBox's default action
        var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal RichTextBox's children
        var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal RichTextBox's child count
        var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal RichTextBox's navigation
        var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal RichTextBox's selection
        var internalAccessible = _owner.RichTextBox?.AccessibilityObject;
        if (internalAccessible != null)
        {
