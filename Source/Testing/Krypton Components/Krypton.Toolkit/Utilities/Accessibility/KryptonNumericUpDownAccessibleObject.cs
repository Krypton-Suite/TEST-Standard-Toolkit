...
/// <summary>
/// Provides accessibility information for KryptonNumericUpDown control.
/// Delegates to the internal NumericUpDown's accessibility object to ensure proper UIA provider support.
/// </summary>
internal class KryptonNumericUpDownAccessibleObject : Control.ControlAccessibleObject
{
    #region Instance Fields
    private readonly KryptonNumericUpDown _owner;
    #endregion

    #region Identity
    /// <summary>
    /// Initialize a new instance of the KryptonNumericUpDownAccessibleObject class.
    /// </summary>
    /// <param name="owner">The KryptonNumericUpDown control that owns this accessible object.</param>
    public KryptonNumericUpDownAccessibleObject(KryptonNumericUpDown owner)
        : base(owner)
    {
        _owner = owner;
    }
    ...
    public override AccessibleRole Role
    {
        get
        {
            // Delegate to internal NumericUpDown's role
            var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
            ...
            // Fall back to Text role for NumericUpDown controls
    ...
    public override AccessibleStates State
    {
        get
        {
            // Delegate to internal NumericUpDown's state
            var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
            if (internalAccessible != null)
            {
    ...
    public override string? Value
    {
        get
        {
            // Delegate to internal NumericUpDown's value
            var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
    ...
    {
        // Delegate to internal NumericUpDown's default action
        var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal NumericUpDown's children
        var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal NumericUpDown's child count
        var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal NumericUpDown's navigation
        var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal NumericUpDown's selection
        var internalAccessible = _owner.NumericUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
