...
/// <summary>
/// Provides rendering for Visual Studio 2017 themes.
/// </summary>
public class RenderVisualStudio2017 : RenderVisualStudio
{
    #region Constructor
    static RenderVisualStudio2017()
    {
    }
    #endregion
    ...
    public override ToolStripRenderer RenderToolStrip([DisallowNull] PaletteBase? colourPalette)
    {
        ...
        var renderer = new KryptonVisualStudio2017Renderer(colourPalette.ColorTable)
        {
