...
/// <summary>
/// Provides rendering for Visual Studio 2013 themes.
/// </summary>
public class RenderVisualStudio2013 : RenderVisualStudio
{
    #region Constructor
    static RenderVisualStudio2013()
    {
    }
    #endregion
    ...
    public override ToolStripRenderer RenderToolStrip([DisallowNull] PaletteBase? colourPalette)
    {
        ...
        var renderer = new KryptonVisualStudio2013Renderer(colourPalette.ColorTable)
        {
