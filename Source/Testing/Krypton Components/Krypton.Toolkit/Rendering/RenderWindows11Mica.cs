...
/// <summary>
/// Provides rendering for Windows 11 Mica themes.
/// </summary>
public class RenderWindows11Mica : RenderMicrosoft365
{
    #region Constructor
    static RenderWindows11Mica()
    {
    }
    #endregion
    ...
    public override ToolStripRenderer RenderToolStrip([DisallowNull] PaletteBase? colourPalette)
    {
        ...
        var renderer = new KryptonWindows11MicaRenderer(colourPalette.ColorTable)
        {
