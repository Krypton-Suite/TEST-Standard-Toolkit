...
/// <summary>
/// Provides rendering for Windows 11 Mica ToolStrip controls.
/// </summary>
/// <seealso cref="KryptonProfessionalRenderer" />
public class KryptonWindows11MicaRenderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonWindows11MicaRenderer()
    {
    ...
    /// <summary>
    /// Initialise a new instance of the KryptonWindows11MicaRenderer class.
    /// </summary>
    /// <param name="kct">Source for text colors.</param>
    public KryptonWindows11MicaRenderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
