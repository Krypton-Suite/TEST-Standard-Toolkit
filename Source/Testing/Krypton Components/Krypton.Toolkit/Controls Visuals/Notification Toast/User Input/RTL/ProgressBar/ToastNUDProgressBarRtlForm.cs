...
internal partial class ToastNUDProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastNUDProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastNUDProgressBarRtlForm_Resize;
    ...
    private void ToastNUDProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    private void ToastNUDProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastNUDProgressBarRtlForm_LocationChanged(object sender, EventArgs e) => UpdateLocation();
    ...
    public static decimal ShowToastNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastNUDProgressBarRtlForm(data);
