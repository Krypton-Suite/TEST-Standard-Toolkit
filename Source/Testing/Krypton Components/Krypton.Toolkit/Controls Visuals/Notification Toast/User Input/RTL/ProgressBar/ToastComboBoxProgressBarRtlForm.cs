...
internal partial class ToastComboBoxProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastComboBoxProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastComboBoxProgressBarRtlForm_Resize;
    ...
    private void ToastComboBoxProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastComboBoxProgressBarRtlForm_LocationChanged(object sender, EventArgs e)
    {

    }

    private void ToastComboBoxProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    internal static string ShowNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastComboBoxProgressBarRtlForm(data);
