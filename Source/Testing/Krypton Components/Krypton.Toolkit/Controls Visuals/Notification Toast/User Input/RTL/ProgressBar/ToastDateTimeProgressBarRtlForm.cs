...
internal partial class ToastDateTimeProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastDateTimeProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastDateTimeProgressBarRtlForm_Resize;
    ...
    private void ToastDateTimeProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    private void ToastDateTimeProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastDateTimeProgressBarRtlForm_LocationChanged(object sender, EventArgs e) => UpdateLocation();
    ...
    internal static DateTime ShowNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastDateTimeProgressBarRtlForm(data);
