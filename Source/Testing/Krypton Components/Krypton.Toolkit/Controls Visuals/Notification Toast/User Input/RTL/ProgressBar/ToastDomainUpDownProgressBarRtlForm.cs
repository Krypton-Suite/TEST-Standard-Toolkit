...
internal partial class ToastDomainUpDownProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastDomainUpDownProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastDomainUpDownProgressBarRtlForm_Resize;
    ...
    private void ToastDomainUpDownProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    private void ToastDomainUpDownProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastDomainUpDownProgressBarRtlForm_LocationChanged(object sender, EventArgs e) => UpdateLocation();
    ...
    internal static string ShowNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastDomainUpDownProgressBarRtlForm(data);
