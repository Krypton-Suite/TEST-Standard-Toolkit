...
internal partial class ToastMaskedTextBoxProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastMaskedTextBoxProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastMaskedTextBoxProgressBarRtlForm_Resize;
    ...
    private void ToastMaskedTextBoxProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    private void ToastMaskedTextBoxProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastMaskedTextBoxProgressBarRtlForm_LocationChanged(object sender, EventArgs e) => UpdateLocation();
    ...
    internal static string ShowNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastMaskedTextBoxProgressBarRtlForm(data);
