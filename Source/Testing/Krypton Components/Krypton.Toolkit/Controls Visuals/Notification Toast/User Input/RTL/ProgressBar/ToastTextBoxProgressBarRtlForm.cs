...
internal partial class ToastTextBoxProgressBarRtlForm : VisualToastNotificationBaseForm
{
    ...
    public ToastTextBoxProgressBarRtlForm(KryptonUserInputToastNotificationData data)
    {
        InitializeComponent();
        ...
        Resize += ToastTextBoxProgressBarRtlForm_Resize;
    ...
    private void ToastTextBoxProgressBarRtlForm_Resize(object? sender, EventArgs e)
    {
    ...
    private void ToastTextBoxProgressBarRtlForm_Load(object sender, EventArgs e)
    {
        UpdateIcon();
    ...
    private void ToastTextBoxProgressBarRtlForm_LocationChanged(object sender, EventArgs e) => UpdateLocation();
    ...
    internal static string ShowNotification(KryptonUserInputToastNotificationData data)
    {
        ...
        using var toast = new ToastTextBoxProgressBarRtlForm(data);
