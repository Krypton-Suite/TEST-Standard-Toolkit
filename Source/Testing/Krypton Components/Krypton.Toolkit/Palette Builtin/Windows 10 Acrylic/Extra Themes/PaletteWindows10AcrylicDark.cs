...
/// <summary>
/// Provides the Dark color scheme variant of the Windows 10 Acrylic palette.
/// </summary>
public class PaletteWindows10AcrylicDark : PaletteWindows10AcrylicBase
{
    #region Static Fields

    #region Ribbon Specific Colors

    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(25, 25, 25);

    private static readonly Color _ribbonAppButtonLightColor = Color.FromArgb(50, 50, 50);
    ...
    static PaletteWindows10AcrylicDark()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteWindows10AcrylicDark class.
    /// </summary>
    public PaletteWindows10AcrylicDark() : base(
        new PaletteWindows10AcrylicDark_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
