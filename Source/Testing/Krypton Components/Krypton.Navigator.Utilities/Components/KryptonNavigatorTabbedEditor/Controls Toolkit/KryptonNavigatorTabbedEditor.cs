...
/// <summary>
/// Provides a tabbed editor control using KryptonNavigator with a KryptonRichTextBox on each tab page.
/// </summary>
[ToolboxItem(true)]
...
[Description(@"Provides a tabbed editor using KryptonNavigator with a KryptonRichTextBox on each page.")]
public class KryptonNavigatorTabbedEditor : VisualPanel
{
    ...
    #region Identity
    /// <summary>
    /// Initialize a new instance of the KryptonNavigatorTabbedEditor class.
    /// </summary>
    public KryptonNavigatorTabbedEditor()
    {
        ...
        // Enable close button on each tab and remove page when closed
    ...
    /// <summary>
    /// Gets the collection of pages (tabs) in this tabbed editor.
    /// </summary>
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    /// <returns>The KryptonRichTextBox editor control, or null if not found.</returns>
    public KryptonRichTextBox? GetEditor(KryptonPage page)
    {
        var index = _navigator.Pages.IndexOf(page);
    ...
    {
        // Not implemented for NavigatorTabbedEditor
    }
    #endregion
    ...
    {
        // Sync editor list when a page is closed via the close button
