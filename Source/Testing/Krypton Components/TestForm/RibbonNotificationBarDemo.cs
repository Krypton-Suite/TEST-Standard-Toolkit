...
public partial class RibbonNotificationBarDemo : KryptonForm
{
	...
	private void SetupRibbonTabs()
	{
		...
		var homeTab = new Krypton.Ribbon.KryptonRibbonTab { Text = "Home" };
		var notificationGroup = new Krypton.Ribbon.KryptonRibbonGroup { Text = "Notifications" };
		
		var showInfoButton = new Krypton.Ribbon.KryptonRibbonGroupButton
		{
			TextLine1 = "Show",
		...
		var showWarningButton = new Krypton.Ribbon.KryptonRibbonGroupButton
		{
			TextLine1 = "Show",
			TextLine2 = "Warning",
		...
		var showErrorButton = new Krypton.Ribbon.KryptonRibbonGroupButton
		{
			TextLine1 = "Show",
			TextLine2 = "Error",
		...
		var showSuccessButton = new Krypton.Ribbon.KryptonRibbonGroupButton
		{
			TextLine1 = "Show",
			TextLine2 = "Success",
		...
		var triple = new Krypton.Ribbon.KryptonRibbonGroupTriple();
		triple.Items.Add(showInfoButton);
		triple.Items.Add(showWarningButton);
		triple.Items.Add(showErrorButton);
		triple.Items.Add(showSuccessButton);
		notificationGroup.Items.Add(triple);
	...
	private void SetupDemoButtons()
	{
		...
		{
			kryptonRibbon.NotificationBar.Type = Krypton.Ribbon.RibbonNotificationBarType.Information;
		...
		{
			kryptonRibbon.NotificationBar.Type = Krypton.Ribbon.RibbonNotificationBarType.Warning;
		...
		{
			kryptonRibbon.NotificationBar.Type = Krypton.Ribbon.RibbonNotificationBarType.Error;
		...
		{
			kryptonRibbon.NotificationBar.Type = Krypton.Ribbon.RibbonNotificationBarType.Success;
		...
		{
			kryptonRibbon.NotificationBar.Type = Krypton.Ribbon.RibbonNotificationBarType.Custom;
	...
	private void ApplyCustomization()
	{
		...
		{
			kryptonRibbon.NotificationBar.Type = (Krypton.Ribbon.RibbonNotificationBarType)cmbNotificationType.SelectedItem;
		}
	...
	private void OnNotificationBarButtonClick(object? sender, Krypton.Ribbon.RibbonNotificationBarEventArgs e)
	{
		string message;
