...
public partial class StartScreen : KryptonForm
{
    ...
    private void AddButtons()
    {
        ...
        CreateButton("File Operation Dialogs", "Comprehensive demo of KryptonFileCopyDialog and KryptonFileCompressionDialog with progress UI, silent mode, path selection, and compression options.", typeof(FileOperationDialogsDemo));
