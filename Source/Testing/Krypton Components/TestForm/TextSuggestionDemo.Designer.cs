...
namespace TestForm
{
    partial class TextSuggestionDemo
    {
        ...
        private KryptonAutoTextSuggestProvider _suggestionProvider1;
        private KryptonAutoTextSuggestProvider _suggestionProvider2;
        private KryptonAutoTextSuggestProvider _suggestionProvider3;
        ...
        private void InitializeComponent()
        {
            ...
            _suggestionProvider1 = new KryptonAutoTextSuggestProvider(this.components)
            {
            ...
            _suggestionProvider2 = new KryptonAutoTextSuggestProvider(this.components)
            {
            ...
            _suggestionProvider3 = new KryptonAutoTextSuggestProvider(this.components)
            {
