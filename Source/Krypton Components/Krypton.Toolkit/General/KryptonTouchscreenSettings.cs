...
public class KryptonTouchscreenSettings : GlobalId
{
    #region Identity

    /// <summary>Initializes a new instance of the <see cref="KryptonTouchscreenSettings" /> class.</summary>
    public KryptonTouchscreenSettings()
    {
    }
