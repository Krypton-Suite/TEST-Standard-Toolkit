...
/// <summary>
/// Provides text suggestion functionality for text controls.
/// </summary>
[ToolboxItem(true)]
[ToolboxBitmap(typeof(KryptonTextSuggestionProvider), "ToolboxBitmaps.KryptonTextSuggestionProvider.bmp")]
[DefaultEvent(nameof(SuggestionSelected))]
[DefaultProperty(nameof(Suggestions))]
[Description("Provides text suggestion functionality for text controls.")]
public class KryptonTextSuggestionProvider : Component
{
    #region Instance Fields
    private Control? _attachedControl;
    private KryptonTextSuggestionPopup? _popup;
    private readonly System.Windows.Forms.Timer _showTimer;
    private readonly List<KryptonTextSuggestionItem> _suggestions = new List<KryptonTextSuggestionItem>();
    ...
    public event EventHandler<KryptonTextSuggestionEventArgs>? SuggestionSelected;
    ...
    public event EventHandler<KryptonTextSuggestionFilterEventArgs>? Filtering;
    #endregion

    #region Identity
    /// <summary>
    /// Initializes a new instance of the KryptonTextSuggestionProvider class.
    /// </summary>
    public KryptonTextSuggestionProvider()
    {
        MinCharsToShow = 1;
        ShowDelay = 300;
        MaxVisibleItems = 8;
    ...
    public KryptonTextSuggestionProvider(IContainer container)
        : this()
    {
        container.Add(this);
    }
    ...
    public List<KryptonTextSuggestionItem> Suggestions => _suggestions;
    ...
    [DefaultValue(KryptonTextSuggestionMatchMode.StartsWith)]
    public KryptonTextSuggestionMatchMode MatchMode { get; set; }
    ...
    internal void ApplySuggestion(KryptonTextSuggestionItem item)
    {
        ...
        try
        {
            var args = new KryptonTextSuggestionEventArgs(item, _attachedControl);
    ...
    private List<KryptonTextSuggestionItem> FilterSuggestions(string filterText)
    {
        var results = new List<KryptonTextSuggestionItem>();
        ...
        foreach (var item in _suggestions)
        {
            ...
            {
                KryptonTextSuggestionMatchMode.StartsWith => itemText.StartsWith(compareText),
                KryptonTextSuggestionMatchMode.Contains => itemText.Contains(compareText),
                KryptonTextSuggestionMatchMode.Fuzzy => FuzzyMatch(itemText, compareText),
        ...
        var args = new KryptonTextSuggestionFilterEventArgs(filterText, results);
    ...
    private void ShowPopup(List<KryptonTextSuggestionItem> suggestions)
    {
        ...
        if (_popup == null || _popup.IsDisposed)
        {
            ...
            _popup = new KryptonTextSuggestionPopup(this, renderer);
        }
...
/// </summary>
public enum KryptonTextSuggestionMatchMode
{
    /// <summary>
