...
/// </summary>
internal class KryptonTextSuggestionPopup : VisualPopup
{
    #region Instance Fields
    private readonly KryptonListBox _listBox;
    private readonly KryptonTextSuggestionProvider _provider;
    #endregion

    #region Identity
    /// <summary>
    /// Initializes a new instance of the KryptonTextSuggestionPopup class.
    /// </summary>
    /// <param name="provider">The suggestion provider.</param>
    /// <param name="renderer">The renderer.</param>
    public KryptonTextSuggestionPopup(KryptonTextSuggestionProvider provider, IRenderer? renderer)
    ...
    public void UpdateSuggestions(List<KryptonTextSuggestionItem> suggestions)
    {
    ...
    public KryptonTextSuggestionItem? GetSelectedItem()
    {
        if (_listBox.SelectedIndex >= 0 && _listBox.SelectedIndex < _listBox.Items.Count)
        {
            return _listBox.Items[_listBox.SelectedIndex] as KryptonTextSuggestionItem;
        }
