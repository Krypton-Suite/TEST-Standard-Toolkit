        ...
        protected override void WndProc(ref Message m)
        {
            ...
            switch (m.Msg)
            {
                ...
                case PI.WM_.MOUSEMOVE:
                {
                    ...
                    {
                        dropRect = new Rectangle(rect.left + borderSize.Width, rect.top, dropDownWidth, fullClientHeight);
                    }
                    else
                    {
                        dropRect = new Rectangle(rect.right, rect.top, dropDownWidth, fullClientHeight);
                    }
                ...
                case PI.WM_.PAINT:
                {
                    ...
                    using (Graphics g = Graphics.FromHdc(hdc))
                    {
                        ...
                        // Store the full client height before adjusting rect for text area
                        // This ensures the drop-down button stretches to full height like KDateTimePicker
                        int fullClientHeight = rect.bottom - rect.top;
                        ...
                        // Create rectangle that represents the drop-down button
                        // Use full client height to match KDateTimePicker stretching behavior
                        Rectangle dropRect;
