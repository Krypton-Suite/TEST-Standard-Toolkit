...
public class KryptonErrorProvider : Component, IExtenderProvider
{
    ...
    {
        _errorProvider?.SetIconPadding(control, value);
    }
    ...
    private static ErrorIconAlignment ConvertIconAlignment(KryptonErrorIconAlignment alignment)
    {
    ...
    private static KryptonErrorIconAlignment ConvertIconAlignment(ErrorIconAlignment alignment)
    {
        return alignment switch
        {
