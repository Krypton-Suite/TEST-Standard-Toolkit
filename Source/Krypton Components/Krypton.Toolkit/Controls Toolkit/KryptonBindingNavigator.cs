...
public class KryptonBindingNavigator : UserControl
{
    ...
    private KryptonButton? _moveFirstButton;
    private KryptonButton? _movePreviousButton;
    private KryptonButton? _moveNextButton;
    private KryptonButton? _moveLastButton;
    private KryptonButton? _addNewButton;
    private KryptonButton? _deleteButton;
    private KryptonTextBox? _positionTextBox;
    private KryptonLabel? _countLabel;
    ...
    {
        return _bindingSource != null && _bindingSource.AllowNew;
    }

    private bool CanDelete()
    {
        return _bindingSource != null && _bindingSource.Count > 0 && _bindingSource.AllowRemove;
    }
    #endregion
}
