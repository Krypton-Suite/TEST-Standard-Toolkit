...
/// <summary>Provides the Visual Studio 2015 Dark theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2015Dark : PaletteVisualStudioBase
{
    ...
    static PaletteVisualStudio2015Dark()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2015Dark" /> class.</summary>
    public PaletteVisualStudio2015Dark()
        : base(
        new PaletteVisualStudio2015Dark_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2015Dark);
    }
