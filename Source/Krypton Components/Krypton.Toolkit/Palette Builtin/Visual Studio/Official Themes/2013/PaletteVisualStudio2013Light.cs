...
/// <summary>Provides the Visual Studio 2013 Light theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2013Light : PaletteVisualStudioBase
{
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2013Light" /> class.</summary>
    ...
    public override IRenderer GetRenderer() => KryptonManager.RenderVisualStudio2013;
