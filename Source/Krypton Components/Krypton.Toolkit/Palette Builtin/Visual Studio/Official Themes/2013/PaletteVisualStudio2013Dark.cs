...
/// <summary>Provides the Visual Studio 2013 Dark theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2013Dark : PaletteVisualStudioBase
{
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2013Dark" /> class.</summary>
