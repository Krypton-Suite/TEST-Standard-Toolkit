...
/// <summary>Provides the Visual Studio 2012 Light theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2012Light : PaletteVisualStudioBase
{
    ...
    static PaletteVisualStudio2012Light()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2012Light" /> class.</summary>
    public PaletteVisualStudio2012Light()
        : base(
        new PaletteVisualStudio2012Light_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2012Light);
    }
