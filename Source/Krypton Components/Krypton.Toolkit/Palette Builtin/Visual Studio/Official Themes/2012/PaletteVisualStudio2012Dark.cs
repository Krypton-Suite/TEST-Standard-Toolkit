...
/// <summary>Provides the Visual Studio 2012 Dark theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2012Dark : PaletteVisualStudioBase
{
    ...
    static PaletteVisualStudio2012Dark()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2012Dark" /> class.</summary>
    public PaletteVisualStudio2012Dark()
        : base(
        new PaletteVisualStudio2012Dark_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
        ThemeName = nameof(PaletteVisualStudio2012Dark);
    }
