...
/// <summary>Provides the Visual Studio 2017 Light theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2017Light : PaletteVisualStudioBase
{
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2017Light" /> class.</summary>
