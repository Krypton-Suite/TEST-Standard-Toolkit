...
/// <summary>Provides the Visual Studio 2017 Dark theme.</summary>
/// <seealso cref="PaletteVisualStudioBase" />
public class PaletteVisualStudio2017Dark : PaletteVisualStudioBase
{
    ...
    /// <summary>Initializes a new instance of the <see cref="PaletteVisualStudio2017Dark" /> class.</summary>
