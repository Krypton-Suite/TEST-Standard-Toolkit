...
/// <summary>
/// Provides a base for Windows 11 Mica palettes.
/// </summary>
/// <seealso cref="PaletteMicrosoft365Base" />
public abstract class PaletteWindows11MicaBase : PaletteMicrosoft365Base
{
    #region Constructor

    /// <summary>
    /// Initializes a new instance of the <see cref="PaletteWindows11MicaBase"/> class.
    /// </summary>
    ...
    protected PaletteWindows11MicaBase(
