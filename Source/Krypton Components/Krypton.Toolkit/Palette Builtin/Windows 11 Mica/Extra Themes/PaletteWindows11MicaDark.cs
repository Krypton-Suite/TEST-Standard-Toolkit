...
/// <summary>
/// Provides the Dark color scheme variant of the Windows 11 Mica palette.
/// </summary>
public class PaletteWindows11MicaDark : PaletteWindows11MicaBase
{
    #region Static Fields

    #region Ribbon Specific Colors

    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(23, 23, 23);

    private static readonly Color _ribbonAppButtonLightColor = Color.FromArgb(48, 48, 48);
    ...
    static PaletteWindows11MicaDark()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteWindows11MicaDark class.
    /// </summary>
    public PaletteWindows11MicaDark() : base(
        new PaletteWindows11MicaDark_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
