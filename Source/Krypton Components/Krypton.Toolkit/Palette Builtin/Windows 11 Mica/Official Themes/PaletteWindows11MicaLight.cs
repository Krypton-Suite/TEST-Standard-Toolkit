...
/// <summary>
/// Provides the Light color scheme variant of the Windows 11 Mica palette.
/// </summary>
public class PaletteWindows11MicaLight : PaletteWindows11MicaBase
{
    ...
    static PaletteWindows11MicaLight()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteWindows11MicaLight class.
    /// </summary>
    public PaletteWindows11MicaLight() : base(
        new PaletteWindows11MicaLight_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
