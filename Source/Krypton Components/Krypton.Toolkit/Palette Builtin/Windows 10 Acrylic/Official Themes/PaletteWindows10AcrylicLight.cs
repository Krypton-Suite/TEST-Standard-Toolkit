...
/// <summary>
/// Provides the Light color scheme variant of the Windows 10 Acrylic palette.
/// </summary>
public class PaletteWindows10AcrylicLight : PaletteWindows10AcrylicBase
{
    ...
    static PaletteWindows10AcrylicLight()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteWindows10AcrylicLight class.
    /// </summary>
    public PaletteWindows10AcrylicLight() : base(
        new PaletteWindows10AcrylicLight_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
