...
public class KryptonVisualStudio2017Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2017Renderer()
    {
    ...
    public KryptonVisualStudio2017Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
