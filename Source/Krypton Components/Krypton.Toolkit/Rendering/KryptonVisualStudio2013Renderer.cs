...
public class KryptonVisualStudio2013Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2013Renderer()
    {
    ...
    public KryptonVisualStudio2013Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
