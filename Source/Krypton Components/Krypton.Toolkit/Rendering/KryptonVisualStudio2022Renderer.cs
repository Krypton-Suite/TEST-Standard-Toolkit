...
public class KryptonVisualStudio2022Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2022Renderer()
    {
    ...
    public KryptonVisualStudio2022Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
