...
/// <summary>
/// Provides rendering for Windows 10 Acrylic ToolStrip controls.
/// </summary>
/// <seealso cref="KryptonProfessionalRenderer" />
public class KryptonWindows10AcrylicRenderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonWindows10AcrylicRenderer()
    {
    ...
    /// <summary>
    /// Initialise a new instance of the KryptonWindows10AcrylicRenderer class.
    /// </summary>
    /// <param name="kct">Source for text colors.</param>
    public KryptonWindows10AcrylicRenderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
