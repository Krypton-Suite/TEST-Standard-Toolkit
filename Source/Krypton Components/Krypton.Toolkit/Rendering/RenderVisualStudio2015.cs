...
/// <summary>
/// Provides rendering for Visual Studio 2015 themes.
/// </summary>
public class RenderVisualStudio2015 : RenderVisualStudio
{
    #region Constructor
    static RenderVisualStudio2015()
    {
    }
    #endregion
    ...
    public override ToolStripRenderer RenderToolStrip([DisallowNull] PaletteBase? colourPalette)
    {
        ...
        var renderer = new KryptonVisualStudio2015Renderer(colourPalette.ColorTable)
        {
