...
public class KryptonVisualStudio2019Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2019Renderer()
    {
    ...
    public KryptonVisualStudio2019Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
