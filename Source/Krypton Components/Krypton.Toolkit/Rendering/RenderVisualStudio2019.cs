...
/// <summary>
/// Provides rendering for Visual Studio 2019 themes.
/// </summary>
public class RenderVisualStudio2019 : RenderVisualStudio
{
    #region Constructor
    static RenderVisualStudio2019()
    {
    }
    #endregion
    ...
    public override ToolStripRenderer RenderToolStrip([DisallowNull] PaletteBase? colourPalette)
    {
        ...
        var renderer = new KryptonVisualStudio2019Renderer(colourPalette.ColorTable)
        {
