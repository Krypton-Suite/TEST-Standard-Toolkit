...
public class KryptonVisualStudio2012Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2012Renderer()
    {
    ...
    public KryptonVisualStudio2012Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
