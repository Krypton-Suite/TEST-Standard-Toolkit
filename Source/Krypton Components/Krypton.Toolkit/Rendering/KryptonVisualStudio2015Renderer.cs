...
public class KryptonVisualStudio2015Renderer : KryptonProfessionalRenderer
{
    ...
    #region Identity
    static KryptonVisualStudio2015Renderer()
    {
    ...
    public KryptonVisualStudio2015Renderer(KryptonColorTable kct)
        : base(kct)
    {
    }
    #endregion
