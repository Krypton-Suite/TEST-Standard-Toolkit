...
/// </summary>
public class ViewDrawButton : ViewComposite, IRippleHost
{
    ...
    #region IRippleHost
    /// <inheritdoc />
    public void StartRipple(Point origin) => _drawCanvas.StartRipple(origin);

    /// <inheritdoc />
    public void CancelRipples() => _drawCanvas.CancelRipples();
    #endregion
