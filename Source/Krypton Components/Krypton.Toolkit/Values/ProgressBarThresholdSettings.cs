...
/// <summary>
/// Storage for progress bar threshold settings (thresholds and enable flags).
/// </summary>
[TypeConverter(typeof(ExpandableObjectConverter))]
public class ProgressBarThresholdSettings : Storage
{
    ...
    /// <summary>
    /// Initialize a new instance of the ProgressBarThresholdSettings class.
    /// </summary>
    /// <param name="owner">Reference to owning control.</param>
    /// <param name="needPaint">Delegate for notifying paint requests.</param>
    public ProgressBarThresholdSettings(KryptonProgressBar owner, NeedPaintHandler needPaint)
    {
