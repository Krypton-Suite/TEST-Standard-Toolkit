...
public class ProgressBarThresholdRegionState
{
    #region Instance Fields

    private readonly ProgressBarThresholdRegionAppearance _parent;
    private readonly ProgressBarThresholdRegionBack _back;
    private readonly ProgressBarThresholdRegionContent _content;
    ...
    public ProgressBarThresholdRegionState(ProgressBarThresholdRegionAppearance parent, Color defaultBackColor1)
    {
        _parent = parent;
        _defaultBackColor1 = defaultBackColor1;
        _back = new ProgressBarThresholdRegionBack(this, defaultBackColor1);
        _content = new ProgressBarThresholdRegionContent(this);
    ...
    /// </summary>
    [Browsable(false)]
    public bool IsDefault => _back.Color1 == _defaultBackColor1 &&
                             _back.IsDefault &&
                             _content.IsDefault;
    ...
    public ProgressBarThresholdRegionBack Back => _back;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    public ProgressBarThresholdRegionContent Content => _content;
    ...
    internal void AssignFrom(ProgressBarThresholdRegionState source)
    {
