...
/// <summary>
/// Provides accessibility information for KryptonDomainUpDown control.
/// Delegates to the internal DomainUpDown's accessibility object to ensure proper UIA provider support.
/// </summary>
internal class KryptonDomainUpDownAccessibleObject : Control.ControlAccessibleObject
{
    #region Instance Fields
    private readonly KryptonDomainUpDown _owner;
    #endregion

    #region Identity
    /// <summary>
    /// Initialize a new instance of the KryptonDomainUpDownAccessibleObject class.
    /// </summary>
    /// <param name="owner">The KryptonDomainUpDown control that owns this accessible object.</param>
    public KryptonDomainUpDownAccessibleObject(KryptonDomainUpDown owner)
        : base(owner)
    {
        _owner = owner;
    }
    ...
    public override AccessibleRole Role
    {
        get
        {
            // Delegate to internal DomainUpDown's role
            var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
            ...
            // Fall back to Text role for DomainUpDown controls
    ...
    public override AccessibleStates State
    {
        get
        {
            // Delegate to internal DomainUpDown's state
            var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
            if (internalAccessible != null)
            {
    ...
    public override string? Value
    {
        get
        {
            // Delegate to internal DomainUpDown's value
            var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
    ...
    {
        // Delegate to internal DomainUpDown's default action
        var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal DomainUpDown's children
        var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal DomainUpDown's child count
        var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal DomainUpDown's navigation
        var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
    ...
    {
        // Delegate to internal DomainUpDown's selection
        var internalAccessible = _owner.DomainUpDown?.AccessibilityObject;
        if (internalAccessible != null)
        {
