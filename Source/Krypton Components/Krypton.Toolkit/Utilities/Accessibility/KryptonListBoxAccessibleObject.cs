...
/// <summary>
/// Provides accessibility information for KryptonListBox control.
/// Delegates to the internal ListBox's accessibility object to ensure proper UIA provider support.
/// </summary>
internal class KryptonListBoxAccessibleObject : Control.ControlAccessibleObject
{
    ...
    #region Identity
    /// <summary>
    /// Initialize a new instance of the KryptonListBoxAccessibleObject class.
    /// </summary>
    /// <param name="owner">The KryptonListBox control that owns this accessible object.</param>
    public KryptonListBoxAccessibleObject(KryptonListBox owner)
        : base(owner)
    {
        _owner = owner;
    }
    ...
    public override AccessibleRole Role
    {
        get
        {
            ...
            // Fall back to List role for ListBox controls
