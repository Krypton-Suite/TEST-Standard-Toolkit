...
public partial class AcrylicHoverRendererTest : KryptonForm
{
    ...
    private void SetupEventHandlers()
    {
        ...
        {
            KryptonManager.AcrylicHoverSettingsStatic.Enabled = checkBoxEnabled.Checked;
            InvalidateControls();
            UpdatePreviewInfo();
        };
        ...
        trackBarIntensity.ValueChanged += (s, e) =>
        {
            ...
            KryptonManager.AcrylicHoverSettingsStatic.Intensity = intensity;
        ...
        comboBoxQuality.SelectedIndexChanged += (s, e) =>
        {
            ...
            {
                KryptonManager.AcrylicHoverSettingsStatic.Quality = (AcrylicHoverQuality)comboBoxQuality.SelectedIndex;
                InvalidateControls();
                UpdatePreviewInfo();
            }
        };
        ...
        {
            KryptonManager.AcrylicHoverSettingsStatic.EnableAnimation = checkBoxAnimation.Checked;
        ...
        {
            KryptonManager.AcrylicHoverSettingsStatic.AnimationDuration = trackBarAnimationDuration.Value;
        ...
        checkBoxCustomLightColor.CheckedChanged += (s, e) =>
        {
            ...
            {
                KryptonManager.AcrylicHoverSettingsStatic.LightColor = panelLightColor.BackColor;
            }
            else
            {
                KryptonManager.AcrylicHoverSettingsStatic.LightColor = null;
            }
        ...
        checkBoxCustomDarkColor.CheckedChanged += (s, e) =>
        {
            ...
            {
                KryptonManager.AcrylicHoverSettingsStatic.DarkColor = panelDarkColor.BackColor;
            }
            else
            {
                KryptonManager.AcrylicHoverSettingsStatic.DarkColor = null;
            }
        ...
        buttonPickLightColor.Click += (s, e) =>
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                KryptonManager.AcrylicHoverSettingsStatic.LightColor = dialog.Color;
                checkBoxCustomLightColor.Checked = true;
                InvalidateControls();
                UpdatePreviewInfo();
            }
        ...
        buttonPickDarkColor.Click += (s, e) =>
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                KryptonManager.AcrylicHoverSettingsStatic.DarkColor = dialog.Color;
                checkBoxCustomDarkColor.Checked = true;
                InvalidateControls();
                UpdatePreviewInfo();
            }
        ...
        {
            KryptonManager.AcrylicHoverSettingsStatic.Reset();
            InitializeSettings();
            InvalidateControls();
        };
    ...
    private void ApplyPreset(PresetType preset)
    {
        ...
        switch (preset)
        {
            case PresetType.HighQuality:
                ...
                settings.Quality = AcrylicHoverQuality.HighQuality;
            ...
            case PresetType.Balanced:
                settings.Enabled = true;
                settings.Intensity = 1.0f;
                settings.Quality = AcrylicHoverQuality.Balanced;
                settings.LightColor = null;
                settings.DarkColor = null;
                settings.EnableAnimation = false;
                break;
            ...
            case PresetType.Performance:
                ...
                settings.Quality = AcrylicHoverQuality.Performance;
                settings.LightColor = null;
                settings.DarkColor = null;
                settings.EnableAnimation = false;
                break;
