...
public partial class ScrollBarTest : KryptonForm
{
    ...
    private void SetupThemedScrollbars()
    {
        ...
        khsbThemed.StateCommon.Back.Color2 = Color.FromArgb(255, 255, 255);
        khsbThemed.StateCommon.Back.ColorStyle = PaletteColorStyle.Linear;
        ...
        khsbThemed.StateActive.Back.Color2 = Color.FromArgb(200, 220, 255);
        ...
        kvsbThemed.StateCommon.Back.Color2 = Color.FromArgb(255, 255, 255);
        kvsbThemed.StateCommon.Back.ColorStyle = PaletteColorStyle.Linear;
        ...
        kvsbThemed.StateActive.Back.Color2 = Color.FromArgb(200, 220, 255);
