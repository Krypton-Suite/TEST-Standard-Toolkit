...
using Krypton.Utilities.FontAwesome;
...
public partial class FontAwesomeTest : KryptonForm
{
    ...
    private void BtnClearCache_Click(object sender, EventArgs e)
    {
        ...
        KryptonMessageBox.Show("Font Awesome icon cache cleared.", "Cache Cleared", MessageBoxButtons.OK, KryptonMessageBoxIcon.Information);
    }
    ...
    private void BtnSetFontPath_Click(object sender, EventArgs e)
    {
        ...
        if (dialog.ShowDialog() == DialogResult.OK)
        {
            ...
            KryptonMessageBox.Show($"Font file path set to:\n{dialog.FileName}\n\nPlease restart the demo to see changes.", 
                "Font Path Set", MessageBoxButtons.OK, KryptonMessageBoxIcon.Information);
        }
    }
    ...
    private void BtnIconPicker_Click(object? sender, EventArgs e)
    {
        ...
        using var dialog = new Krypton.Utilities.FontAwesome.Designers.FontAwesomeIconPickerDialog();
