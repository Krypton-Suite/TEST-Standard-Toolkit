...
public partial class JumpListTest : KryptonForm
{
    ...
    private void InitializeJumpList()
    {
        ...
        Taskbar.JumpList.AppId = "KryptonToolkit.JumpListTest";
    ...
    private void SetupBasicExamples()
    {
        ...
        {
            Taskbar.JumpList.AppId = "KryptonToolkit.JumpListTest";
            UpdateStatus("Application ID set: " + Taskbar.JumpList.AppId);
        };
    ...
    private void SetupCategoryExamples()
    {
        ...
        {
            Taskbar.JumpList.ClearCategories();
    ...
    private void SetupKnownCategoriesExamples()
    {
        ...
        {
            Taskbar.JumpList.ShowFrequentCategory = !Taskbar.JumpList.ShowFrequentCategory;
            UpdateStatus($"Frequent category: {(Taskbar.JumpList.ShowFrequentCategory ? "Enabled" : "Disabled")}");
        };
    ...
    private void BtnAddUserTask_Click(object? sender, EventArgs e)
    {
        ...
        Taskbar.JumpList.UserTasks.Add(task);
    ...
    private void BtnAddMultipleTasks_Click(object? sender, EventArgs e)
    {
        ...
        UpdateStatus($"Added {Taskbar.JumpList.UserTasks.Count} user tasks");
    }
    ...
    private void BtnAddTemplates_Click(object? sender, EventArgs e)
    {
        ...
        Taskbar.JumpList.AddCategory("Templates", templates);
