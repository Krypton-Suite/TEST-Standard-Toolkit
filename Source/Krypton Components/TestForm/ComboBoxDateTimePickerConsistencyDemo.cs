...
public partial class ComboBoxDateTimePickerConsistencyDemo : KryptonForm
{
    ...
    private void SetupStyleVariations()
    {
        ...
        cmbInputControl.InputControlStyle = InputControlStyle.InputControl;
        ...
        dtpInputControl.InputControlStyle = InputControlStyle.InputControl;
    ...
    private void BtnToggleStyle_Click(object? sender, EventArgs e)
    {
        ...
        var style = _styleToggle ? InputControlStyle.Standalone : InputControlStyle.InputControl;
