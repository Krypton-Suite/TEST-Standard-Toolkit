...
public class KryptonScrollBar : Control
{
    ...
    public KryptonScrollBar()
    {
        ...
        _stateCommon = new PaletteInputControlTripleRedirect(_paletteRedirect, PaletteBackStyle.InputControlStandalone, PaletteBorderStyle.HeaderCalendar, PaletteContentStyle.LabelNormalPanel, OnNeedPaintHandler);
        _stateDisabled = new PaletteInputControlTripleStates(_stateCommon, OnNeedPaintHandler);
        _stateNormal = new PaletteInputControlTripleStates(_stateCommon, OnNeedPaintHandler);
        _stateActive = new PaletteInputControlTripleStates(_stateCommon, OnNeedPaintHandler);
    ...
    private void OnNeedPaintHandler(object? sender, NeedLayoutEventArgs e) => Invalidate();
